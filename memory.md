...
- Branch: `codex/feishu-global-manager-app`
- Baseline: `main` at `a99e49c`
- The branch was created directly from `main`; it does not merge or cherry-pick `codex/global-task-monitor`.
...
- Do not push or commit this feature unless explicitly requested.

## Verification

- `npm test`: 966 tests, 964 passed, 2 skipped, 0 failed.
